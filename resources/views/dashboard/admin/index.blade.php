                            ...
                            <div class="chart-wrapper mx-auto">
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu mx-auto">
                                      <h4 class="mb-3 mx-4">Mobile Legends</h4>
                                      <li class="mb-3 mx-4">
                                      ...
                                      <h4 class="mb-3 mx-4">Valorant</h4>
                                      <li class="mb-3 mx-4">
                                        > @foreach ($sports as $sport)
                                      ...
                                      <h4 class="mb-3 mx-4">Point Blank</h4>
                                      <li class="mb-3 mx-4">
                                        > @foreach ($sports as $sport)
                                            @if ($sport->category_id === 3)
                                                <td>{{ $loop->last }}</td>
                                            @endif
                                        @endforeach  Peserta
                                      </li>
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="chart-wrapper mx-auto">
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu mx-auto">
                                      <h4 class="mb-3 mx-4">Photografer</h4>
                                      <li class="mb-3 mx-4">
                                        > @foreach ($arts as $art) 
                                      ...
                                      <h4 class="mb-3 mx-4">Solo Vocal</h4>
                                      <li class="mb-3 mx-4">
                                        > @foreach ($arts as $art) 
