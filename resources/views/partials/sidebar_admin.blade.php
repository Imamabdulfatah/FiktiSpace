        ...
        <div class="sidebar-wrapper active">
            ...
            <div class="sidebar-menu">
                <ul class="menu">
                        ...
                        <li class="sidebar-item   {{ ($active === "sport") ? 'active' : '' }} has-sub">
                            ...
                            <ul class="submenu ">  
                                <li>
                                    <a href="/admin/data-mobile-legends">Mobile Legends</a>
                                </li>
                                <li>
                                    <a href="/admin/data-futsal">Futsal</a>
                                </li>
                                <li>
                                    <a href="/admin/data-basket">Basket</a>
                                </li>
                                <li>
                                    <a href="/admin/data-bulu-tangkis">Bulu Tangkis</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item {{ ($active === "art") ? 'active' : '' }} has-sub">
                            <a href="#" class='sidebar-link'>
                                <i data-feather="file-text" width="20"></i> 
                                <span>Art</span>
                            </a>                    
                            <ul class="submenu ">
                                <li>
                                    <a href="/admin/data-solo-vocal">Solo Vocal</a>
                                </li>
                                
                                <li>
                                    <a href="/admin/data-poster">Poster</a>
                                </li>        
                            </ul>
                        </li>                
